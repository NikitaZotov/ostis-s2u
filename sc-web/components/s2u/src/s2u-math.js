S2u.Vector2 = function (x, y) {
    this.x = x;
    this.y = y;
};

S2u.Vector2.prototype = {
    constructor: S2u.Vector2,
    ...
    clone: function () {
        return new S2u.Vector2(this.x, this.y);
    },
...
// --------------------
S2u.Vector3 = function (x, y, z) {
    this.x = x;
    this.y = y;
    this.z = z;
};

S2u.Vector3.prototype = {
    constructor: S2u.Vector3,
    ...
    clone: function () {
        return new S2u.Vector3(this.x, this.y, this.z);
    },
...
S2u.Math.distanceSquared = function (p1, p2) {
    var x = p1.x - p2.x,
        y = p1.y - p2.y;
 ...
 * @param point object with 'x' and 'y' fields, {S2u.Vector2} for example
 ...
 */
S2u.Algorithms.isPointInPolygon = function (point, vertecies) {
 ...
 * @param segStart the first point, object with 'x' and 'y' fields, {S2u.Vector2} for example
 * @param segEnd the second point, object with 'x' and 'y' fields, {S2u.Vector2} for example
 * @return {Array} intersection points
 */
S2u.Algorithms.polyclip = function (pin, segStart, segEnd) {
