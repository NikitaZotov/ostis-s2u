S2uBusListener = function (scene) {
    this.scene = scene;
};

S2uBusListener.prototype = {

    constructor: S2uBusListener,
    ...
    onMouseDownObject: function (obj) {
        if (!this.scene.bus_data.source && !obj.bus && !(obj instanceof S2u.ModelBus)) {
            ...
            if (obj instanceof S2u.ModelContour) {
    ...
    finishCreation: function () {
        this.scene.commandManager.execute(new S2uCommandCreateBus(this.scene.bus_data.source, this.scene));
    }
