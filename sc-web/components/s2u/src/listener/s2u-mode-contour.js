S2uContourListener = function (scene) {
    this.scene = scene;
};

S2uContourListener.prototype = {

    constructor: S2uContourListener,
    ...
    finishCreation: function () {
        this.scene.commandManager.execute(new S2uCommandCreateContour(this.scene));
    }
